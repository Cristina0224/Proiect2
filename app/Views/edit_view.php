...
<table>
    <tr>
    <td style="padding-top: 10px;"><?php echo form_label('Title', 'title');?></td>
    <td style="padding-top: 10px;"><?php echo form_input($data1);?></td>
    </tr>
    <tr>
    <td style="padding-top: 10px;"><?php echo form_label('Image', 'poza');?></td>
    <td style="padding-top: 10px;"><?php echo form_upload($data2);?></td>
    </tr> 

</table>
<h2><img  style="padding-top: 10px;" src="<?php echo base_url($image['poza']); ?>" width="200" height="100"></h2>
